...
const routes: Routes = [
  ...
  { path: 'edit-spdocument/:id_sp_data', data: {title: 'Edit SP Document'}, loadChildren: () => import('./pages/edit-spdocument/edit-spdocument.module').then(m => m.EditSpdocumentModule) },
  { path: 'view-spdocument/:id_sp_data', data: {title: 'View SP Document'}, loadChildren: () => import('./pages/view-spdocument/view-spdocument.module').then(m => m.ViewSpdocumentModule) },
